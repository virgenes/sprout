...
/* Scans the ELF image for signatures to auto-detect native function offsets
 * for unknown or unlisted libPVZ2.so versions. Returns true if key offsets were found. */
