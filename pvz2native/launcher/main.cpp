...
static LRESULT CALLBACK wnd_proc(HWND hwnd,UINT msg,WPARAM wp,LPARAM lp){
    static HFONT hF=0,hB=0,hT=0,hS=0;
    static HBRUSH hBg=0;
    switch(msg){
        case WM_CREATE:{
            set_dark_title(hwnd);
            ...
            #define R1 145   /* Video mode */
            #define R2 185   /* FPS limit */
            #define R3 248   /* Quality */
            #define R4 288   /* Shadows */
            #define R5 328   /* Render scale */
            #define R6 398   /* Language */
            #define R7 440   /* Emulate IAP */
            #define R8 480   /* Persist saves */
            #define R9 520   /* Console */
        ...
        case WM_DESTROY:{
            ...
            if(hT)DeleteObject(hT); if(hS)DeleteObject(hS);
        ...
        case WM_PAINT:{
            ...
            RECT card={CARD_L,100,CARD_R,540};
            ...
            MoveToEx(dc,CARD_L+16,215,NULL); LineTo(dc,CARD_R-16,215);
            MoveToEx(dc,CARD_L+16,370,NULL); LineTo(dc,CARD_R-16,370);
            ...
            label(145,L"Window mode");
            label(185,L"FPS limit");
            label(248,L"Quality");
            label(288,L"Shadows");
            label(328,L"Render scale");
            label(398,L"Language");
            EndPaint(hwnd,&ps);
            return 0;
        }
